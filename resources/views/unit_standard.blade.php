...
<div class="container page__container page-section pb-0">
   ...
   <button class="btn float-right btn-outline-secondary mb-2" data-toggle="modal"
      data-target="#unit_standard">add</button>
   <br><br>
         ...
         <div class="alert alert-soft-secondary mb-lg-32pt">
            <div class="d-flex flex-wrap align-items-start">
               <div class="mr-8pt">
                  ...
                  border: 1px solid #dddfe2; display: flex; align-items: center; justify-content: center;"><i
                        class="fas fa-folder"></i></div>
               </div>
               <div class="flex">
                  <small class="text-100">
                     <strong class="text-muted"> {{$unit_standard->us_title}}</strong><br>
                     <span class="badge badge-pill text-muted" style="border: 1px solid #ebe6e6">
                        {{$unit_standard->us_name}}</span>
                  </small>
               </div>
               <div class="flex">
                  <small class="text-100 mt-1 float-right">
                     <a href="{{ route('unit_standard/view_details',$unit_standard->us_name) }}"
                        class="btn btn-outline-secondary rounded"><i class="fas fa-eye"></i></a>
                  </small>
               </div>
            </div>
         </div>
