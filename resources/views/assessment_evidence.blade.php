        ...
        <div class="card-header p-0 nav">
            <div class="row no-gutters" role="tablist">
                ...
                <div class="col-auto border-left border-right">
                    <a href="{{ route('assessment_evidence') }}"
                ...
                <table class="table mb-0 thead-border-top-0 table-nowrap">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-name">Unit
                                    Standard</a>
                            </th>

                            <th style="width: 150px;">
                                <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-department">Unit
                                    Standard Title</a>
                            </th>

                            <th style="width: 48px;">
                                <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-status">Unit
                                    Standard Level </a>
                            </th>

                            <th style="width: 48px;">
                                <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-type">Unit Standard
                                    Credit</a>
                            </th>

                            <th style="width: 48px;">
                                <a href="javascript:void(0)" class="sort"
                                    data-sort="js-lists-values-phone">Caategory</a>
                            </th>

                            <th style="width: 48px;">
                                <a href="javascript:void(0)" class="sort desc" data-sort="js-lists-values-date">View
                                    Files</a>
                            </th>
                            <th style="width: 48px;">
                                Learner Name
                    ...
                    <tbody class="list" id="employees">
                        <tr>
                            ...
                            <td>
                                <small class="js-lists-values-date text-50"><a href="#" class="text-50 text-danger"><i
