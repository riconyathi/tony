...
<div class="container page__container page-section pb-0">
    ...
    <div class="row">
        ...
        @if ($unit_standard->evidence->isEmpty())
        <div class="col-lg-12 p-5">
            <div class="alert alert-soft-secondary mb-lg-32ptt">
                <form action="/evidence/upload" method="post" enctype="multipart/form-data" class="row">
                    ...
                    <div class="col-lg-4" style="box-shadow: none;border: none !important; ">
                       <div class="card p-2">
                        <input type="hidden" class="form-control" name="us_id" value="{{$unit_standard->id}}">
        ...
        @foreach ($unit_standard->evidence as $evidence)
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-50">
                                            <a href="{{public_path('evidence/'.$evidence->formative)}}"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-50">
                                            <a href="{{public_path('evidence/'.$evidence->summative)}}"
                                                class="btn btn-sm btn-outline-success"><i class="fa fa-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-50">
                                            <a href="{{public_path('evidence/'.$evidence->other)}}"
