                          ...
                          <div class="col-md-6 list-group list-group-form">
                            <div class="list-group-item">
                              <div class="form-group row align-items-center mb-0">
                                ...
                                <div class="col-sm-12">
                                  <input name="us_name" type="text" class="form-control"  value="{{$unit_standard->us_name}}">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="list-group-item">
                              <div class="form-group row align-items-center mb-0">
                                ...
                                <div class="col-sm-12">
                                  <input name="us_title" type="text" class="form-control"  value="{{$unit_standard->us_title}}">
                                </div>
                              </div>
                            </div>  
                          </div>
                          ...
                          <div class="col-md-6 list-group list-group-form">
                            ...
                            <div class="list-group-item">
                              <div class="form-group row align-items-center mb-0">
                                ...
                                <div class="col-sm-12">
                                  <input name="us_level" type="text" class="form-control"  value="{{$unit_standard->us_level}}">
                                </div>
                              </div>
                            </div>
                            <div class="list-group-item">
                              <div class="form-group row align-items-center mb-0">
                                ...
                                <div class="col-sm-12">
                                  <input name="us_credit" type="text" class="form-control"  value="{{$unit_standard->us_credit}}">
                                </div>
                              </div>
                            </div>  
                          </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="text-50"><a href="" class="btn btn-sm btn-outline-secondary"><i class="fa fa-eye"></i></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="position-relative mr-16pt">
                                                    <div class="text-center fullbleed d-flex align-items-center justify-content-center flex-column z-0">
                                                        <i class="fa fa-file-word" style="color: rgb(0, 89, 255); font-size: 25px;"></i>
                                                    </div>
                                                ...
                                                <div class="text-50"><a href="" class="btn btn-sm btn-outline-success"><i class="fa fa-download"></i></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="text-50"><a href="" class="btn btn-sm btn-outline-success"><i class="fa fa-download"></i></a></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
