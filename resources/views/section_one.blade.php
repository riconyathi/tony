                    ...
                    <div class="card-header p-0 nav">
                        <div class="row no-gutters" role="tablist">
                            ...
                            <div class="col-auto border-left border-right">
                                <a href="{{ route('school_details',auth()->user()->id) }}"
                            ...
                            <div class="col-auto border-left border-right">
                                <a href="{{ route('tertiary_details',auth()->user()->id) }}"
                                    class="dashboard-area-tabs__tab card-body d-flex flex-row align-items-center justify-content-start ">
                                        ...
                                        <div class="page-section">
                                            ...
                                            <div class="list-group-item">
                                                <div class="form-group row align-items-center mb-0">
                                                    <label class="form-label col-form-label col-sm-3">
                                                        Race</label>
                                                    <select name="race"
                                                        class="custom-control custom-select form-control col-sm-9">
                                                        <option value="{{$user->learners->race}}">
                                                            {{$user->learners->race}}</option>
                                                ...
                                                <div class="form-group row align-items-center mb-0">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input name="citizenship" type="text" class="form-control"
                                                            value="{{$user->learners->citizenship}}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="list-group-item">
                                                <div class="form-group row align-items-center mb-0">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="phone" name="home_phone" class="form-control"
                                            ...
                                            <div class="list-group-item">
                                                <div class="form-group row align-items-center mb-0">
                                                    <label class="form-label col-form-label col-sm-3">Cell
                                                        Number</label>
                                                    <div class="col-sm-9">
                                            ...
                                            <div class="list-group-item">
                                                <div class="form-group row align-items-center mb-0">
                                                    <label class="form-label col-form-label col-sm-3">Email
                                                        address</label>
                                                    <div class="col-sm-9">
