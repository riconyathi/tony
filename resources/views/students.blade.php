                    ...
                    <table class="table mb-0 thead-border-top-0 table-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <a href="javascript:void(0)" class="sort text-muted" data-sort="js-lists-values-name">Student Id</a>
                                </th>
                                
                                <th style="width: 150px;">
                                    <a href="javascript:void(0)" class="sort text-muted" data-sort="js-lists-values-department">Student Name</a>
                                </th>
                                <th style="width: 150px;">
                                    <a href="javascript:void(0)" class="sort text-muted" data-sort="js-lists-values-department">Student Name</a>
                                </th>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 24px;" class="text-muted">Add</th>
                            </tr>
                        </thead>
                        <tbody class="list" id="employees">
                            @foreach ($learners as $learner)
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="#" class="text-50 text-danger"><i class="fas fa-user-plus"></i></a>
                                </td>
