        ...
        <div class="col-md-4">
            <div class="card border-left-4 border-left-primary border-right-primary">
                <div class="card-body text-70 flex"
                    ...
                    </span> <span><a href="{{ route('classes') }}" class="btn btn-outline-secondary">Get
                            started</a></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-left-4 border-left-success border-right-success">
                <div class="card-body text-70 flex"
                    ...
                    </span> <span><a href="{{ route('users') }}" class="btn btn-outline-secondary">Get
                            started</a></span>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-left-4 border-left-success border-right-success">
                <div class="card-body text-70 flex"
                    style="display: flex; flex-wrap: wrap; justify-content: space-between;">
                    <span>
                        <h5 class="text-muted">Learners</h5>
                    </span> <span><a href="{{ route('learners/view') }}" class="btn btn-outline-secondary">Get
                            started</a></span>
                </div>
            </div>
        </div>
